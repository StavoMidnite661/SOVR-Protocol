---------------- MODULE AGENT_CAPABILITY_BINDING_V06_LIFECYCLE ----------------
\* SOVR Financial OS — Generated TLA+ Model
\* Compiler: 0.6.0 Protocol: 1.0.0
\* Provenance: agent_capability_binding_v06_lifecycle
...
\* Trigger: AGENT_CAPABILITY_BOUND

ACTIVE_TO_ACTIVE_2 == 
    /\ state = "ACTIVE"
    /\ state' = "ACTIVE"
    /\ visited' = visited \cup {"ACTIVE"}
\* Trigger: AGENT_CAPABILITY_REVOKED
