---------------- MODULE IDENTITY_CREDENTIAL_LIFECYCLE ----------------
\* SOVR Financial OS — Generated TLA+ Model
\* Compiler: 0.6.0 Protocol: 1.0.0
\* Provenance: identity_credential_lifecycle

EXTENDS Naturals, Sequences

VARIABLES state, visited

States == {"ACTIVE", "EXPIRED", "REVOKED", "ROTATED", "SUSPENDED"}

FinalStates == {"REVOKED", "ROTATED"}
