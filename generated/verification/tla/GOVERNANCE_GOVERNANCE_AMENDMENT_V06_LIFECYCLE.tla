---------------- MODULE GOVERNANCE_GOVERNANCE_AMENDMENT_V06_LIFECYCLE ----------------
\* SOVR Financial OS — Generated TLA+ Model
\* Compiler: 0.6.0 Protocol: 1.0.0
\* Provenance: governance_governance_amendment_v06_lifecycle
...
\* Trigger: GOVERNANCE_AMENDMENT_PROPOSED

ACTIVE_TO_ACTIVE_2 == 
    /\ state = "ACTIVE"
    /\ state' = "ACTIVE"
    /\ visited' = visited \cup {"ACTIVE"}
\* Trigger: GOVERNANCE_AMENDMENT_RATIFIED
...
Next == 
    ACTIVE_TO_ACTIVE \/ ACTIVE_TO_ACTIVE_2 \/ Terminated
