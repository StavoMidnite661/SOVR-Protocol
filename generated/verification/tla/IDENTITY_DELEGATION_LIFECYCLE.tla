---------------- MODULE IDENTITY_DELEGATION_LIFECYCLE ----------------
\* SOVR Financial OS — Generated TLA+ Model
\* Compiler: 0.6.0 Protocol: 1.0.0
\* Provenance: identity_delegation_lifecycle

EXTENDS Naturals, Sequences

VARIABLES state, visited

States == {"ACTIVE", "EXPIRED", "PENDING_ACCEPTANCE", "REVOKED"}

FinalStates == {"EXPIRED", "REVOKED"}

Init == 
    /\ state = "PENDING_ACCEPTANCE"
    /\ visited = {"PENDING_ACCEPTANCE"}
