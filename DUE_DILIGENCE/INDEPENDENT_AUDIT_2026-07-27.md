...
| 8 | Runtime purity audit: PASS, 0 violations | ⚠️ **TRUE BUT WEAK** | Script passes. But it scans 56 of 70 runtime `.ts` files (80%) and greps for ~12 fixed patterns. Not a proof of purity. |
...
**Score: 7 verified, 1 weak, 11 false or misleading.**
