...
**Current architecture and live counts:** `docs/ARCHITECTURE.md`.
Released / phase narratives below `[1.0.0]` and older may use superseded
counts and hashes. Treat those as history.
