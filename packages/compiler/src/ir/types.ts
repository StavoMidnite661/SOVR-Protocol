// ============================================================
// SOVR IR Types — Protocol Intermediate Representation
// ============================================================
// Fully resolved, typed, content-addressable, deterministic
// No inference, one-to-one traceability, stable symbol names
...
export interface CommandNode extends ProtocolNode {
  ...
  capability: string;
  gates: { identity_required: boolean; capability_required: boolean; policy_required: boolean };
}
...
export interface EventNode extends ProtocolNode {
  ...
  envelope: any; // mandatory envelope spec
}
