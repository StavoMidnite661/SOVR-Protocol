// ============================================================
// SOVR Compiler — Validation Expression Language (VEL) Generator
// File: packages/compiler/src/generators/vel.ts
// ============================================================
import { SOVR_IR } from '../ir/types.js';
import { GeneratedFile } from './typescript.js';
import { sha256 } from '../utils/hash.js';

export function generateVEL(ir: SOVR_IR): GeneratedFile[] {
