// ============================================================
// SOVR Compiler — AI-Agent "Governor Sandbox" & Intent SDK Generator
// File: packages/compiler/src/generators/agents.ts
// ============================================================
import { SOVR_IR } from '../ir/types.js';
import { GeneratedFile } from './typescript.js';
import { sha256 } from '../utils/hash.js';

export function generateAgentSandbox(ir: SOVR_IR): GeneratedFile[] {
