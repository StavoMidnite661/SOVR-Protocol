import type { TigerBeetleTransport } from './tigerbeetle-transport.js';
...
export class LedgerAdapter implements LedgerAdapterBoundary {
  private readonly client: TigerBeetleTransport;
  private readonly accountMapper: AccountMapper;
  private readonly transferMapper: TransferMapper;
  private readonly config: LedgerAdapterConfig;

  constructor(client: TigerBeetleTransport, accountMapper: AccountMapper, transferMapper: TransferMapper, config: LedgerAdapterConfig) {
    this.client = client;
